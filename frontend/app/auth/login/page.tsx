...
export default function LoginPage() {
  ...
  // Don't show login form if already authenticated or still loading
  if (authLoading || isAuthenticated) {
    return null
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Sign in to your ExpenseTracker account</CardDescription>
        </CardHeader>
