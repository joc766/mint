...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    const { error: registerError } = await register(email, password, firstName, lastName)
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Sign up for ExpenseTracker to manage your finances</CardDescription>
        </CardHeader>
